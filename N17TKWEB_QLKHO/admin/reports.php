<?php
// admin/reports.php - Trang quản lý báo cáo
session_start();
...
<body>
    <header class="header">
        ...
        <ul class="nav-menu">
            ...
            <li><a href="reports.php" class="active">Quản Lý Báo Cáo</a></li>
        </ul>
        <button class="logout-btn" onclick="location.href='../logout.php'">Đăng Xuất</button>
    </header>

    <div class="container">
        <h1 style="text-align: center; margin-bottom: 20px; color: #d4af37;">Quản Lý Báo Cáo</h1>
